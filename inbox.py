...
class Inbox:
    ...
    def receive_file(self, filename: str, data: bytes,
        ...
        if xml_data:
            ...
            item.status = "VERARBEITET"
            item.error = ("PDF ohne strukturierten Teil (kein XRechnung/ZUGFeRD) – "
                           "manuelle Prüfung erforderlich: Rechnung bitte von Hand erfassen "
                           "oder beim Absender als E-Rechnung anfordern.")
